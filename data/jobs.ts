...
export const jobs: Job[] = [
  ...
  },
  {
    ...
    period: "2018 - 2021",
    description: "Developed and maintained web applications using Django, Flask, and PostgreSQL. Implemented CI/CD pipelines and automated testing for Python applications.",
    longDescription: "At DataDriven Systems, I was responsible for developing and maintaining multiple web applications using Django and Flask frameworks. I worked closely with the DevOps team to implement CI/CD pipelines using Jenkins and Docker, which reduced deployment time by 50%. I also established automated testing practices that improved code quality and reduced bugs in production by 30%.",
    technologies: ["Python", "Django", "Flask", "PostgreSQL", "Jenkins", "Docker"],
    achievements: [
      "Developed 5+ web applications serving over 10,000 daily active users",
  ...
  },
  {
    ...
    longDescription: "Starting my career at TechStart Labs, I gained foundational experience in web development using Python and Django. I collaborated with senior developers and frontend teams to build RESTful APIs and design database schemas. This role taught me the importance of clean code, proper documentation, and agile development practices.",
